...
N_array = np.load('csmlm_sigma_vs_n_L_100_N_array.npy')

σ_CRB_N = dict()
σ_CRB_N['L100'] = np.load('csmlm_sigma_vs_n_L_100_av_sigma_array.npy')
σ_CRB_N['L200'] = np.load('csmlm_sigma_vs_n_L_200_av_sigma_array.npy')
σ_CRB_N['L400'] = np.load('csmlm_sigma_vs_n_L_400_av_sigma_array.npy')
σ_CRB_N['L600'] = np.load('csmlm_sigma_vs_n_L_600_av_sigma_array.npy')

sbr_array = np.load('csmlm_sigma_vs_sbr_L_100_sbr_array.npy')

σ_CRB_sbr = dict()
σ_CRB_sbr['L100'] = np.load('csmlm_sigma_vs_sbr_L_100_av_sigma_array.npy')
σ_CRB_sbr['L200'] = np.load('csmlm_sigma_vs_sbr_L_200_av_sigma_array.npy')
σ_CRB_sbr['L400'] = np.load('csmlm_sigma_vs_sbr_L_400_av_sigma_array.npy')
σ_CRB_sbr['L600'] = np.load('csmlm_sigma_vs_sbr_L_600_av_sigma_array.npy')

fov_array = np.load('csmlm_sigma_vs_fov_L_100_fov_array.npy')

σ_CRB_fov = dict()
σ_CRB_fov['L100'] = np.load('csmlm_sigma_vs_fov_L_100_av_sigma_array.npy')
σ_CRB_fov['L200'] = np.load('csmlm_sigma_vs_fov_L_200_av_sigma_array.npy')
σ_CRB_fov['L400'] = np.load('csmlm_sigma_vs_fov_L_400_av_sigma_array.npy')
σ_CRB_fov['L600'] = np.load('csmlm_sigma_vs_fov_L_600_av_sigma_array.npy')

params_file = 'csmlm_crb_params.txt'

crb_map = np.load('csmlm_crb_σ_CRB.npy')
...
ax[0, 1].plot(fov_array, σ_CRB_fov['L200'], label='L = 200 nm')
ax[0, 1].plot(fov_array, σ_CRB_fov['L400'], label='L = 400 nm')
...
ax[1, 0].plot(sbr_array, σ_CRB_sbr['L200']) 
ax[1, 0].plot(sbr_array, σ_CRB_sbr['L400']) 
...
ax[1, 1].plot(N_array, σ_CRB_N['L200'])
ax[1, 1].plot(N_array, σ_CRB_N['L400'])
